...
Route::group(['prefix' => 'api'], function ($router) {
    ...
    Route::group(['namespace' => 'Webkul\API\Http\Controllers\Shop', 'middleware' => ['locale', 'theme', 'currency']], function ($router) {
        ...
        Route::get('country-state-cities', 'CoreController@getCountryStateCityGroup');

        Route::get('get-all-cities', 'CoreController@getAllCities');

        Route::get('city-name/{id}', 'CoreController@getCityName');
