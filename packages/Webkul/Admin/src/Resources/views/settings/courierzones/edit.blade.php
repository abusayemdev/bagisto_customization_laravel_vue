...
@section('page_title')
    {{ __('admin::app.settings.courierzones.edit-title') }}
@stop

@section('content')
    <div class="content">

        <form method="POST" action="{{ route('admin.courierzones.update', $courierzone->id) }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
                    ...
                    <accordian :title="'{{ __('admin::app.settings.courierzones.general') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('zone_name') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="zone_name" name="zone_name" value="{{ $courierzone->zone_name }}" data-vv-as="&quot;{{ __('admin::app.settings.courierzones.zone-name') }}&quot;" readonly/>
                            ...
                            <div class="control-group" :class="[errors.has('weight_increase_rate') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="weight_increase_rate" name="weight_increase_rate" value="{{ $courierzone->weight_increase_rate }}" data-vv-as="&quot;{{ __('admin::app.settings.courierzones.weight-increase-rate') }}&quot;"/>
                            ...
                            <div class="control-group" :class="[errors.has('initial_shipping_charge') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="initial_shipping_charge" name="initial_shipping_charge" data-vv-as="&quot;{{ __('admin::app.settings.courierzones.initial-shipping-charge') }}&quot;" value="{{$courierzone->initial_shipping_charge }}"/>
                            ...
                            <div class="control-group" :class="[errors.has('shipping_charge_increase_rate') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="shipping_charge_increase_rate" name="shipping_charge_increase_rate" data-vv-as="&quot;{{ __('admin::app.settings.courierzones.shipping-charge-increase-rate') }}&quot;" value="{{$courierzone->shipping_charge_increase_rate }}"/>
                            ...
                            <div class="control-group" :class="[errors.has('shipping_charge_type') ? 'has-error' : '']">
                                ...
                                <select class="control" id="shipping_charge_type" name="shipping_charge_type" data-vv-as="&quot;{{ __('admin::app.settings.courierzones.shipping-charge-type') }}&quot;">
                                    ...
                                    <option value="per_total_weight" {{ ($courierzone->shipping_charge_type == "per_total_weight") ? 'selected' : '' }}  title="Per Total Weight">Per Total Weight</option>
                                    <option value="per_product_weight" {{ ($courierzone->shipping_charge_type == "per_product_weight") ? 'selected' : '' }}  title="Per Product Weight">Per Product Weight</option>
                                </select>
