...
Route::group(['middleware' => ['web']], function () {
    Route::prefix(config('app.admin_url'))->group(function () {
        ...
        Route::group(['middleware' => ['admin']], function () {
            ...
            // countrystate Routes
            Route::get('/countrystates', 'Webkul\Core\Http\Controllers\CountryStateController@index')->defaults('_config', [
            'view' => 'admin::settings.countrystates.index',
            ])->name('admin.countrystates.index');

            Route::get('/countrystates/create', 'Webkul\Core\Http\Controllers\CountryStateController@create')->defaults('_config', [
                'view' => 'admin::settings.countrystates.create',
            ])->name('admin.countrystates.create');

            Route::post('/countrystates/create', 'Webkul\Core\Http\Controllers\CountryStateController@store')->defaults('_config', [
                'redirect' => 'admin.countrystates.index',
            ])->name('admin.countrystates.store');

            Route::get('/countrystates/edit/{id}', 'Webkul\Core\Http\Controllers\CountryStateController@edit')->defaults('_config', [
                'view' => 'admin::settings.countrystates.edit',
            ])->name('admin.countrystates.edit');

            Route::put('/countrystates/edit/{id}', 'Webkul\Core\Http\Controllers\CountryStateController@update')->defaults('_config', [
                'redirect' => 'admin.countrystates.index',
            ])->name('admin.countrystates.update');

            Route::post('/countrystates/delete/{id}', 'Webkul\Core\Http\Controllers\CountryStateController@destroy')->name('admin.countrystates.delete');


            // city Routes
            Route::get('/cities', 'Webkul\Core\Http\Controllers\CityController@index')->defaults('_config', [
            'view' => 'admin::settings.cities.index',
            ])->name('admin.cities.index');

            Route::get('/cities/create', 'Webkul\Core\Http\Controllers\CityController@create')->defaults('_config', [
                'view' => 'admin::settings.cities.create',
            ])->name('admin.cities.create');

            Route::post('/cities/create', 'Webkul\Core\Http\Controllers\CityController@store')->defaults('_config', [
                'redirect' => 'admin.cities.index',
            ])->name('admin.cities.store');

            Route::get('/cities/edit/{id}', 'Webkul\Core\Http\Controllers\CityController@edit')->defaults('_config', [
                'view' => 'admin::settings.cities.edit',
            ])->name('admin.cities.edit');

            Route::put('/cities/edit/{id}', 'Webkul\Core\Http\Controllers\CityController@update')->defaults('_config', [
                'redirect' => 'admin.cities.index',
            ])->name('admin.cities.update');

            Route::post('/cities/delete/{id}', 'Webkul\Core\Http\Controllers\CityController@destroy')->name('admin.cities.delete');

            Route::get('/cities-import', 'Webkul\Core\Http\Controllers\CityController@cities_import')->defaults('_config', [
                'view' => 'admin::settings.cities.import',
            ])->name('admin.cities-import');

            Route::post('/cities-import-store', 'Webkul\Core\Http\Controllers\CityController@cities_import_store')->defaults('_config', [
                'redirect' => 'admin.cities.index',
            ])->name('admin.cities-import-store');

            Route::get('/cities-export', 'Webkul\Core\Http\Controllers\CityController@cities_export')->name('admin.cities-export');

            Route::get('/country-states/{country_id}', 'Webkul\Core\Http\Controllers\CityController@country_states');
            
                
            //courier zone Routes
            Route::get('/courierzones', 'Webkul\Core\Http\Controllers\CourierZoneController@index')->defaults('_config', [
            'view' => 'admin::settings.courierzones.index',
            ])->name('admin.courierzones.index');

            Route::get('/courierzones/create', 'Webkul\Core\Http\Controllers\CourierZoneController@create')->defaults('_config', [
                'view' => 'admin::settings.courierzones.create',
            ])->name('admin.courierzones.create');

            Route::post('/courierzones/create', 'Webkul\Core\Http\Controllers\CourierZoneController@store')->defaults('_config', [
                'redirect' => 'admin.courierzones.index',
            ])->name('admin.courierzones.store');

            Route::get('/courierzones/edit/{id}', 'Webkul\Core\Http\Controllers\CourierZoneController@edit')->defaults('_config', [
                'view' => 'admin::settings.courierzones.edit',
            ])->name('admin.courierzones.edit');

            Route::put('/courierzones/edit/{id}', 'Webkul\Core\Http\Controllers\CourierZoneController@update')->defaults('_config', [
                'redirect' => 'admin.courierzones.index',
            ])->name('admin.courierzones.update');

            Route::post('/courierzones/delete/{id}', 'Webkul\Core\Http\Controllers\CourierZoneController@destroy')->name('admin.courierzones.delete');


            //pickup location Routes
            Route::get('/pickup-location', 'Webkul\Admin\Http\Controllers\Sales\PickupLocationController@index')->defaults('_config', [
                'view' => 'admin::settings.pickuplocations.index',
            ])->name('admin.pickup-location.index');

            Route::get('/pickup-location/create', 'Webkul\Admin\Http\Controllers\Sales\PickupLocationController@create')->defaults('_config', [
                'view' => 'admin::settings.pickuplocations.create',
            ])->name('admin.pickup-location.create');

            Route::post('/pickup-location/create', 'Webkul\Admin\Http\Controllers\Sales\PickupLocationController@store')->defaults('_config', [
                'redirect' => 'admin.pickup-location.index',
            ])->name('admin.pickup-location.store');

            Route::get('/pickup-location/edit/{id}', 'Webkul\Admin\Http\Controllers\Sales\PickupLocationController@edit')->defaults('_config', [
                'view' => 'admin::settings.pickuplocations.edit',
            ])->name('admin.pickup-location.edit');

            Route::put('/pickup-location/edit/{id}', 'Webkul\Admin\Http\Controllers\Sales\PickupLocationController@update')->defaults('_config', [
                'redirect' => 'admin.pickup-location.index',
            ])->name('admin.pickup-location.update');

            Route::post('/pickup-location/delete/{id}', 'Webkul\Admin\Http\Controllers\Sales\PickupLocationController@destroy')->name('admin.pickup-location.delete');


            //service charge Routes
            Route::get('/service-charge', 'Webkul\Admin\Http\Controllers\Sales\ServiceChargeController@index')->defaults('_config', [
                'view' => 'admin::settings.servicecharge.index',
            ])->name('admin.service-charge.index');

            Route::get('/service-charge/create', 'Webkul\Admin\Http\Controllers\Sales\ServiceChargeController@create')->defaults('_config', [
                'view' => 'admin::settings.servicecharge.create',
            ])->name('admin.service-charge.create');

            Route::post('/service-charge/create', 'Webkul\Admin\Http\Controllers\Sales\ServiceChargeController@store')->defaults('_config', [
                'redirect' => 'admin.service-charge.index',
            ])->name('admin.service-charge.store');

            Route::get('/service-charge/edit/{id}', 'Webkul\Admin\Http\Controllers\Sales\ServiceChargeController@edit')->defaults('_config', [
                'view' => 'admin::settings.servicecharge.edit',
            ])->name('admin.service-charge.edit');

            Route::put('/service-charge/edit/{id}', 'Webkul\Admin\Http\Controllers\Sales\ServiceChargeController@update')->defaults('_config', [
                'redirect' => 'admin.service-charge.index',
            ])->name('admin.service-charge.update');

            Route::post('/service-charge/delete/{id}', 'Webkul\Admin\Http\Controllers\Sales\ServiceChargeController@destroy')->name('admin.service-charge.delete');
