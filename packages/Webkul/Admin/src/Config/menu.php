...
return [
    [
        ...
        'key'        => 'settings.countrystates',
        'name'       => 'admin::app.layouts.countrystates',
        'route'      => 'admin.countrystates.index',
        'sort'       => 9,
        'icon-class' => '',
    ],[
        'key'        => 'settings.cities',
        'name'       => 'admin::app.layouts.cities',
        'route'      => 'admin.cities.index',
        'sort'       => 10,
        'icon-class' => '',
    ],[
        'key'        => 'settings.courierzones',
        'name'       => 'admin::app.layouts.courierzones',
        'route'      => 'admin.courierzones.index',
        'sort'       => 11,
        'icon-class' => '',
    ],[
        'key'        => 'settings.pickuplocations',
        'name'       => 'admin::app.layouts.pickuplocations',
        'route'      => 'admin.pickup-location.index',
        'sort'       => 12,
        'icon-class' => '',
    ],[
        'key'        => 'settings.servicecharge',
        'name'       => 'admin::app.layouts.servicecharge',
        'route'      => 'admin.service-charge.index',
        'sort'       => 13,
        'icon-class' => '',
    ], [
        'key'        => 'marketing',
