...
class Payment
{
     ...
     * @return array
     */
    public function getSupportedPaymentMethods($pickup_locations, $shippingMethod)
    {
        ...
        return [
            ...
            'html'            => view('shop::checkout.onepage.payment', compact('paymentMethods','pickup_locations','shippingMethod'))->render(),
        ];
    }
