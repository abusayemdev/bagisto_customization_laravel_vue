...
class CreateOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->decimal('base_shipping_charge', 12, 4)->default(0)->nullable();
            $table->decimal('shipping_charge', 12, 4)->default(0)->nullable();

            $table->decimal('base_service_fee', 12, 4)->default(0)->nullable();
            $table->decimal('service_fee', 12, 4)->default(0)->nullable();
            
            $table->integer('pickup_location_id')->unsigned()->nullable();
