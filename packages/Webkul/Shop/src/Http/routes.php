...
Route::group(['middleware' => ['web', 'locale', 'theme', 'currency']], function () {
    ...
    //Checkout Save Order
    Route::post('/checkout/summary', 'Webkul\Shop\Http\Controllers\OnepageController@summary')->name('shop.checkout.summary');
    ...
    //Checkout Save Pickup Location Store
    Route::post('/checkout/save-pickup-location', 'Webkul\Shop\Http\Controllers\OnepageController@savePickupLocation')->name('shop.checkout.save-pickup-location');
